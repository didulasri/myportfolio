...
const experience = {
  ...
  description: 'Contributed as a full-stack developer to the Irrigation Department ERP System',
  responsibilities: [
  ...
  technologies: ['React.js', 'Spring Boot', 'RESTful APIs', 'SonarQube', 'Java', 'JavaScript'],
};
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 rounded-xl bg-accent-cyan/10 border-2 border-accent-cyan">
                  <svg className="w-8 h-8 text-accent-cyan" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-2">
                {education.highlights.map((item, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <CheckCircle className="text-accent-cyan mt-1 flex-shrink-0" size={16} />
                    <p className={`font-mono text-sm ${
                      theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                    }`}>
                      {item}
