...
const skills = [
  ...
  { category: "Tools & Others", items: ["Git", "Docker", "SonarQube"] },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div
              className={`space-y-4 font-mono text-sm md:text-base leading-relaxed ${
                theme === "dark" ? "text-gray-300" : "text-gray-700"
              }`}
            >
              <p>
                I&apos;m an early-career software engineer with hands-on experience
                designing, building, and maintaining production-ready
                applications. I&apos;m comfortable working across the full
                development lifecycle, from understanding requirements to
                delivering reliable, scalable solutions.
              </p>
              <p>
                Known for taking ownership of tasks, learning new systems
                quickly, and writing maintainable code that aligns with real
                business needs. I actively seek opportunities where high
                standards, continuous learning, and meaningful impact are
                valued.
              </p>
              <p>
                Currently in my final year at University of Moratuwa, I&apos;ve
                contributed to various projects ranging from AI-powered
                conversational commerce to hospital management systems, always
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {highlights.map((item, index) => {
              ...
              return (
                <div
                  key={item.title}
                  className={`p-6 rounded-xl border-2 transition-all hover:scale-105 hover:border-primary ${
                    theme === "dark"
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {skillGroup.items.map((skill) => (
                    <span
                      key={skill}
                      className={`px-3 py-1.5 rounded-lg font-mono text-sm border transition-all hover:scale-105 ${
                        theme === "dark"
